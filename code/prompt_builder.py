...
def save_prompt_to_file(prompt_content: str, filename: str) -> str:
    """Saves the given prompt string to a markdown file in the prompts directory.

    Args:
        prompt_content: The string content of the prompt to be saved.
        filename: The desired filename for the file (e.g., "my_new_prompt").
